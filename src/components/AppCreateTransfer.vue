        ...
        <div class="col1">
            <div class="input-group">
                ...
                <div class="wrapper-for-input">
                    <input v-model="nametransfer" type="text" name="name" class="form-input name" id="">
                </div>
            </div>
            <div class="input-group">
            ...
            <div class="input-group">
                ...
                <div class="wrapper-for-input">
                    <input v-model="timefrom"  pattern="\d{1,2}:\d{1,2}" type="time" name="timefrom" class="form-input timefrom" id="">
                </div>
            </div>
        </div>
        <div class="col1">
            <div class="input-group">
                ...
                <div class="wrapper-for-input">
                    <input v-model="timeto"  pattern="\d{1,2}:\d{1,2}" type="time" name="timeto" class="form-input timeto" id="">
                </div>
            </div>
            <div class="input-group">
