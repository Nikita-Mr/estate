...
<template>
  <div class="wrapperNews mt-1 mb-1">
    <input type="text" name="title" class="titleInput" id="" placeholder="заголовок новости">
    <div>
      <vue-tinymce v-model="content" :options="options" />

    </div>
    <button class="create-news">Создать</button>
  </div>
</template>
